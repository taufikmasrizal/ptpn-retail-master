...
@section('content')
    ...
    <div class="card">
                                            <div class="card-header">
                                                <h5>Tabel Data About Content</h5>
                                      ...
                                      <label class="float-label"><i class="fa fa-search m-r-10"></i>Search Data</label>
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        @foreach($about_content as $data)
                                                            <tr>
                                                                ...
                                                                <td> <a href="{{ route('About_content.edit', $data->id)}}" class="btn btn-primary"> Edit</a></td>
                                                                <td> <form action="{{ route('About_content.destroy', $data->id)}}" method="post">
                                                                @csrf
                                                                @method('DELETE')
                                                    ...
                                                    <h6>Jumlah Data : {{ $about_content->total()}} </h6>
                                                    {{  $about_content->links() }}
                                                </div>
                                            </div>
                                        </div>
