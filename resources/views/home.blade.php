...
<head>
    <title>Dashboard NusaKita</title>
    ...
    <!-- waves.css -->
    <link rel="stylesheet" href="frontend/assets/pages/waves/css/waves.min.css" type="text/css" media="all">
      <!-- Required Fremwork -->
      <link rel="stylesheet" type="text/css" href="frontend/assets/css/bootstrap/css/bootstrap.min.css">
      <!-- waves.css -->
      <link rel="stylesheet" href="frontend/assets/pages/waves/css/waves.min.css" type="text/css" media="all">
      <!-- themify icon -->
      <link rel="stylesheet" type="text/css" href="frontend/assets/icon/themify-icons/themify-icons.css">
      <!-- Font Awesome -->
      <link rel="stylesheet" type="text/css" href="frontend/assets/icon/font-awesome/css/font-awesome.min.css">
      <!-- scrollbar.css -->
      <link rel="stylesheet" type="text/css" href="frontend/assets/css/jquery.mCustomScrollbar.css">
        <!-- am chart export.css -->
  ...
  <div id="pcoded" class="pcoded">
          ...
          <nav class="navbar header-navbar pcoded-header">
              <div class="navbar-wrapper">
                  <div class="navbar-logo">
                      ...
                      <a href="index.html">
                          <img class="img-fluid" src="frontend/assets/images/nusakita-logo.png" alt="Theme-Logo" />
                      </a>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-purple">{{ $products ?? '' }}</h4>
    ...
    <script type="text/javascript" src="frontend/assets/js/popper.js/popper.min.js"></script>
    <script type="text/javascript" src="frontend/assets/js/bootstrap/js/bootstrap.min.js "></script>
    <script type="text/javascript" src="frontend/assets/pages/widget/excanvas.js "></script>
    <!-- waves js -->
    <script src="frontend/assets/pages/waves/js/waves.min.js"></script>
    <!-- jquery slimscroll js -->
    <script type="text/javascript" src="frontend/assets/js/jquery-slimscroll/jquery.slimscroll.js "></script>
    <!-- modernizr js -->
    <script type="text/javascript" src="frontend/assets/js/modernizr/modernizr.js "></script>
    <!-- slimscroll js -->
    <script type="text/javascript" src="frontend/assets/js/SmoothScroll.js"></script>
    <script src="frontend/assets/js/jquery.mCustomScrollbar.concat.min.js "></script>
    <!-- Chart js -->
    <script type="text/javascript" src="assets/js/chart.js/Chart.js"></script>
    <!-- amchart js -->
    <script src="https://www.amcharts.com/lib/3/amcharts.js"></script>
    <script src="frontend/assets/pages/widget/amchart/gauge.js"></script>
    <script src="frontend/assets/pages/widget/amchart/serial.js"></script>
    <script src="frontend/assets/pages/widget/amchart/light.js"></script>
    <script src="frontend/assets/pages/widget/amchart/pie.min.js"></script>
    <script src="https://www.amcharts.com/lib/3/plugins/export/export.min.js"></script>
    <!-- menu js -->
    <script src="frontend/assets/js/pcoded.min.js"></script>
    <script src="frontend/assets/js/vertical-layout.min.js "></script>
    <!-- custom js -->
    <script type="text/javascript" src="frontend/assets/pages/dashboard/custom-dashboard.js"></script>
